...
public:
	...
	void GetInverse( cyMatrix4f &inverse ) { inverse=*this; inverse.Invert(); }		///< Get the inverse of this matrix
	cyMatrix4f GetInverse() { cyMatrix4f inv(*this); inv.Invert(); return inv; }	///< Get the inverse of this matrix
...
/// add a isFixed value to the matrix
...
/// Overloaded addition operator
/// add a isFixed value to the matrix modify matrix
...
/// subtract a isFixed value from a cyMatrix4f
inline cyMatrix4f cyMatrix4f::operator -( const float value ) const
{
	cyMatrix4f buffer; // create a temp cyMatrix4f object not to change this
...
/// Overloaded subtraction operator
/// subtract a isFixed value from a cyMatrix4f modify this matrix
inline void cyMatrix4f::operator -=( const float value )
{
	for ( int i = 0; i < 16; i++ )
...
/// Overloaded subtraction operator
/// subtract the matrix from a isFixed value
inline cyMatrix4f operator-( const float value, const cyMatrix4f &right )
{
	cyMatrix4f buffer; // create a temp cyMatrix4f object not to change right
...
/// Overloaded multiplication operator
/// multiply a isFixed value with the matrix
inline cyMatrix4f operator*( const float value, const cyMatrix4f &right )
{
	cyMatrix4f buffer; // create a temp cyMatrix4f object not to change right
