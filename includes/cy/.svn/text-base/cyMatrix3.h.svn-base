...
public:
	...
	void GetInverse( cyMatrix3f &inverse ) { inverse=*this; inverse.Invert(); }		///< Get the inverse of this matrix
	cyMatrix3f GetInverse() { cyMatrix3f inv(*this); inv.Invert(); return inv; }	///< Get the inverse of this matrix
...
/// subtract a isFixed value from a cyMatrix3f
inline cyMatrix3f cyMatrix3f::operator -( const float value ) const
{
	cyMatrix3f buffer; // create a temp cyMatrix3f object not to change this
...
/// Overloaded subtraction operator
/// subtract a isFixed value from a cyMatrix3f modify this matrix
inline void cyMatrix3f::operator -=( const float value )
{
	for ( int i=0; i<9; i++ )
